...
import { SelectableText, VocabularyCapture } from '../VocabularyCapture'
...
import { paragraphs } from './reader-utils'
...
export function AdditionalMedia({ site }: { site: WorldHeritageSite }) {
...
export function HeritageVideo({ site }: { site: WorldHeritageSite }) {
...
export function JapaneseTranslation({ text }: { text: string }) {
  return (
